                  ...
                  <form method="post" id="handleAjax" action="{{route('project.save')}}" name="formfield"
                      ...
                      <div class="accordion" id="myAccordion">
                        <div class="accordion-item">
                          <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                            aria-expanded="true" data-bs-target="#collapseOne">Step1 - Selection Profile</button>
                          <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                            <div class="card-body">
                              ...
                              <div class="form-group" style="margin-top: -30px;"> <label><span>*</span> Project Disciplines</label>
                                 <!--<div class="multiSelect">-->
                                  <select name="project_disciplines"  class="multiSelect_field" id="project_disciplines" style="width: 100%; height: 40px;" data-placeholder="Project Disciplines">
                                  <option value="Select">Select Project Disciplines</option>
                                  <option value="Civil">Civil</option>
                                  <option value="Mechanical">Mechanical</option>
                                  <option value="Electrical"> Electrical</option>
                                  <option value="Chemical"> Chemical</option>
                                  <option value="Areonautical">Areonautical</option>
                                  <option value="Minings">Minings</option>
                    ...
                    <div class="m-4" >
                      <div class="accordion" id="myAccordion">
                        <div class="accordion-item">
                          <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                            data-bs-target="#collapseTwo">Step2 - Main Disciplines</button>
                          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                            <div class="card-body">
                              <div class="form-group" style="color: #000000"> <label><span>*</span> Engineering
                                  Disciplines</label>

                                <select   class="multiSelect_field" name="engineering" onchange='checkvalue(this.value)'
                                  data-placeholder="Select a Engineering Disciplines" style="width: 100%; height: 40px; color: #000000 !important;" tabindex="-1" id="engineering" >
                                  ...
                                  <input type="text" name="engineering_other" id="engineering3" class="form-control" style='display:none'/>
                      </div>
                          
                  <div class="form-group" style="color: #000000"> <label><span>*</span> Allied
                                  Disciplines</label>
                                ...
                                <select  class="multiSelect_field" name="allied" onchange='alliedvalue(this.value)' 
                                 ...
                                 >
                                  ...
                                  <option value="Agronomy & Agriculture">Agronomy & Agriculture</option>
                                  ...
                                  <option value="others"> Others </option>
                                  <!--Allied Professions Total Allied Professions-->
                                </select>
                    ...
                    <div class="m-4">
                      <div class="accordion" id="myAccordion">
                        <div class="accordion-item">
                          <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                            data-bs-target="#collapseThree">Step3 - Term of Reference </button>
                          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                <label><span>*</span> No. of Experts Required</label>
                                <input type="text" name="expert" class="form-control" value="{{ old('expert') }}" id="expert"   />
                              </div>

                              <div class="form-group">
                                <label><span>*</span> Delivery Schedule - Days</label>
                                <input type="text" name="schedule" class="form-control" value="{{ old('schedule') }}" id="schedule"  />
                              </div><br>

                              <!--<div class="form-group">-->
                              <!--  <label><span>*</span> Project Deliverables </label>-->
                              <!--  <input type="text" name="total_inputs" class="form-control" value="{{ old('total_inputs') }}" id="total_inputs" />-->
                              <!--</div><br>-->

                              <div class="form-group" style="margin-top: -30px;"> <label><span>*</span> Type of Contract
                                </label>
                                <select name="contract" class="form-control" id="contract">
                                  <option value="Select">Select Type of Contract</option>
                                  <option value="Specific">Specific</option>
                                  <option value="On Call (Prequalified consultant will be invited on need basis)">On
                              ...
                              <!--<div class="form-group">-->
                              <!--  <label><span>*</span> Option of Prequalification and Request for Proposal (RFP) /-->
                              <!--    Request for Quote (RFQ)</label>-->
                              <!--  <textarea type="text" name="prequalification"-->
                              <!--    class="form-control" id="prequalification">{{old('prequalification')}}</textarea>-->
                              <!--</div>-->

                              <!--<div class="form-group">-->
                              <!--  <label><span>*</span> Scope of Work (Title Bar and Upload Doc)</label>-->
                              ...
                              <div class="control">
                                ...
                                <label class="radio" style="margin-left: 5px;">
                                  <input type="radio"  onclick="javascript:yesnoCheck();"  value="No" name="technical_proposal" id="technical_proposal" >
                                  No
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="m-4" >
                      <div class="accordion" id="myAccordion" >
                        <div class="accordion-item" id="ifYes" style="visibility:hidden">
                          <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                            data-bs-target="#collapseFour" >Step4 - Selection Method (Fields for selection)</button>
                          <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                            <div class="card-body">
                              ...
                              <div class="form-group" style="margin-top: -30px;"> <label> Commercial
                                  (select one)</label> <select name="commercial" class="form-control" value="{{ old('commercial') }}" id="commercial"
                                  >
                    ...
                    <!--    style="margin-top: 20px; background-color: #004E1E; color: #fff; margin-bottom: 30px;">Submit</button>-->
                    <!--</div>-->
