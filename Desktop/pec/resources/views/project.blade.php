      ...
      <div class="container  mt-2" style="background-color:#F8F8F8; height:100%; color: #000; box-shadow: 20px 20px 50px 15px grey; margin-bottom: 30px; margin-top: 50px; ">
        <div class="row">
          ...
          <img src ="../images/pec_logo.png" style="margin-top: 40px; width: 100%; , margin-left: 10px;" >
            ...
            @endif
            <form method="post" id="handleAjax" action="{{route('projects.store')}}" name="formfield" enctype="multipart/form-data">
                <div class="m-4">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
              ...
              <div class="form-group" >
                ...
                <input type="text" name="project_title" class="form-control" id="project_title"/>
              </div><br>
              <div class="form-group" style="margin-top: -30px;"> <label ><span>*</span> Project Disciplines</label><br>  <select  name="project_disciplines" style="width: 350px;" class="form-control" id="project_disciplines" required>
    ...
    <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            ...
            <div class="form-group" style="color: #000000"> <label ><span>*</span> Engineering Disciplines</label>
             <select class="form-control"  name="engineering" data-placeholder="Select a Engineering Disciplines" style="width: 100%; color: #000000 !important;" tabindex="-1" id="engineering">
                ...
                <div class="form-group" style="color: #000000"> <label ><span>*</span> Allied Disciplines</label>
                 <select class="form-control"  name ="allied" data-placeholder="Select a Allied Disciplines" style="width: 100%;" tabindex="-1" id="allied">
    ...
    <div class="accordion" id="myAccordion">
        <div class="accordion-item">
         ...
         <br> 
              ...
              <!--<div class="form-group">-->
              <!--  <label ><span>*</span>	Delivery Schedule - Days</label>-->
              <!--  <input  type="number" name="no_of_days" class="form-control" id="schedule"/>-->
              <!--</div>-->
      ...
      <div class="hdtuto control-group lst input-group" style="margin-top:5px;">
        ...
        <div class="input-group-btn"> 
          <button class="btn btn-danger" type="button"><i class="fldemo glyphicon glyphicon-remove"></i> Remove</button>
            ...
            <div class="form-group" style="text-align: center;" >
                <button type="button"  id="submitBtn" data-toggle="modal" data-target="#confirm-submit" class="btn btn-default"  style="margin-top: 20px; background-color: #004E1E; color: #fff; margin-bottom: 30px;">Post a Project</button>
              </div>    
        ...
        <div class="modal-content" style="width: 700px;" >
            ...
            <div class="modal-body" >
                ...
                <table class="table">
                    <tr>
                        <th>Project Title</th>
                        <td ><label id="project_title_lb"></label></td>
                    </tr>
                    <tr>
