...
@section('content')
    ...
    <section id="hero d-flex"
        ...
        <div class="hero-container">
            <div class="row mobile-column-reverse">
                <div class="col-lg-5 col-md-6 d-flex mobile-text-margin" style="align-items: center">
                    <div class="row" style="">
                        <div class="col-lg-3 col-md-3"></div>
                        <div class="col-lg-9 col-md-9 d-flex header-left mobile-text-center">
                            <div class="">
                                <h1 style=" color:#333333; margin:0px; font-weight:600" class="">
                                    <span>Welcome to </span>
                                    <span style= "color: #21573d"> &nbsp;PEC</span>
                                </h1>
                                <h1 style="color:#333333;" class="">
                                    <span>E-Gateway Portal</span>
                                </h1>
                                <h5 style= "color: #21573d" class="">Project of PPDC</h5>
                                <p style="color:#333333; font-weight:400; font-size:1rem; padding:2vw 0;">
                                    <span>A Portal For International Companies Seeking Engineering
                                        Consultancy Services Of PEC Registered Consultants
                                    </span>
                                </p>
                                <div class="" style="font-weight:600;">
                                    <a href="{{ route('login') }}/client" class="button mobile-button" title="Test"
                                        ...
                                        In as a Client</a>
                                    <a href="{{ route('login') }}/consultant" class="button mobile-button"
                ...
                <div class="col-lg-4 col-md-2 d-flex justify-content-center mobile-header">
                    <img class="welcome-image mobile-image" src="{{ url('public/assets_new/img/new6.png') }}" alt=""
    ...
    <div class="image-container"
        style="width:100%; height:100%; min-height:7rem ;color:white; background-image:url({{ url('public/assets_new/img/layer-2-1@2x-Copy.png') }})">

        <div class="row pt-3">
            {{-- <img class="green-texture-img" src="{{ url('public/assets_new/img/layer-2-1@2x - Copy.png') }}" alt="">  --}}
            <div class="col-lg-1"></div>
            <div class="col-lg-5 col-md-5 mobile-text-center" style="padding-left:50px">
                <h3 style="margin-bottom:0px" class="mobile-heading">Looking for a <span
                        style="font-weight: bold">PEC</span>
                    Consultant</h3>
                <h3 style="" class="mobile-heading"> Book an <span style="font-weight: bold">Appointment</span>
                    Quickly</h3>
            </div>
            <div class="col-lg-6 col-md-6 " style="padding:12px">
                <div class="row">
                    <div class="col-lg-2 col-md-6"></div>
                    <div class="col-lg-10 col-md-6 d-flex justify-content-center">
                        <a href="{{ route('login') }}/client" class="button mobile-button"
    ...
    <!-- ======= video Section ======= -->
    <section>
        <div class="container" data-aos="fade-up" style="padding:0px 50px">
            <h3><span style="font-weight:600;">Step by Step </span><span
                    style="font-weight:600; color: #21573d">Guide</span></h3>
            <div class="row no-gutters">
                <div class="col-lg-12 video-box"
                    ...
                    <iframe
                        ...
                        width: 100%;
                        height: 100%;"
                        src="https://www.youtube.com/embed/AWlV7T2TYGs?autoplay=1&mute=1" title="YouTube video player"
                        frameborder="0"
    ...
    <section>
        <div class="row">
            ...
            <div class="col-lg-5 col-md-4 imgbox d-flex align-items-center justify-content-center" style="">
                <div class="row">
                    <div class="col-lg-1 col-md-2"></div>
                    <div class="col-lg-10 col-md-10 d-flex justify-content-center" style="padding:0px">
                        <img class="img mobile-pic" src="{{ asset('assets_new/img/pec-chairmain.jpg') }}" alt=""
                            style="padding-bottom:15px">
                    </div>
                </div>
            </div>

            <div class="col-lg-6 col-md-6 mobile-text-justify" style="padding:0px 35px;">
                <h1 style="font-weight:600" class="d-flex justify-content-center mobile-heading">Message of PEC <span
                        style= "color: #21573d">
                        &nbsp;Chairman</span></h1>
                <p style="color: #333333;">Pakistan Engineering Council has an agenda to create
                    opportunities for its members, and create avenues to export the Pakistani Engineering technical
                    expertise globally.
                </p>
                <p style="color: #333333;">The PEC E-Gateway is a digital procurement system of Pakistan
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-4 imgbox d-flex align-items-center justify-content-center" style="">
                <div class="row">
                    <div class="col-lg-1 col-md-2"></div>
                    <div class="col-lg-10 col-md-10 d-flex justify-content-center" style="padding: 0px">
                        <img class="img mobile-pic" src="{{ asset('assets_new/img/mir.jpeg') }}" alt=""
                            style="padding-bottom:15px">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mobile-text-justify" style="padding:0 35px;">
                <h1 style="font-weight:600; color: #21573d" class="d-flex justify-content-center mobile-heading">Greetings
                </h1>
                <p style="color: #333333;">The E-Gateway is one of important initiatives by the Pakistan Engineering
                    Council,
                ...
                <p style="color: #333333;"><b>Engr. Mir Masood Rashid (Convenor, PEC Pakistan Development Committee)</b>
                </p>
            </div>
        </div>
    </section>
    ...
    <section style="padding-bottom:0px">
        <div class="row d-flex">
            <div class="col-lg-1"></div>
            <div class="col-lg-10">
                <h3 class="d-flex best-solution" style="padding:15px 0px"><span
                        style="font-weight:600; color: #21573d">Best Solution &nbsp;</span> For Your Buisness </h3>
                <div class="solution-slider mobile-sol-slider" style="overflow: hidden">
                    <figure>
                        <div class="row" style="width:max-content">
                            <img src="{{ url('public/assets_new/img/agri.jpg') }}">
                            <img src="{{ url('public/assets_new/img/computer.jpg') }}">
                            <img src="{{ url('public/assets_new/img/data.jpg') }}">
                            <img src="{{ url('public/assets_new/img/electronic.jpg') }}">
                            <img src="{{ url('public/assets_new/img/planning.jpg') }}">
                            <img src="{{ url('public/assets_new/img/research.jpg') }}">
                            <img src="{{ url('public/assets_new/img/software.jpg') }}">
                            <img src="{{ url('public/assets_new/img/survey.jpg') }}">
                            <img src="{{ url('public/assets_new/img/tender.jpg') }}">
                        </div>
                    </figure>
                </div>
            </div>
    ...
    <section style="padding-bottom:0px">
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-6">
                    <h3><span style="font-weight:600;">Active </span><span style="font-weight:600; color: #21573d">Projects</span>
                    </h3>
                </div>
                <div class="col-6">
                    <a class="" style="float: right;"
                            href="{{ route('available_projects') }}"><u> View All Projects </u></a>
                    {{-- <h6 style="float:right"><span style="font-weight:600;">Active </span><span style="font-weight:600; color: #21573d">Projects</span> --}}
                    {{-- </h6> --}}
                </div>
            </div>
            ...
            <div class="row">
                @if (!empty($query))
                    @if (!$query->isEmpty())
                        @foreach($query ->take(3) as $row)
                                <div class="col-lg-4 box-123 mb-3 ">

                                    <section data-qa="job-tile"
                                        class="up-card job-tile vs-cursor-pointer p-md-20 p-15 mb-md-20 "
                                        style="padding: 15px;">
                                        ...
                                        <div class="job-tile-content">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-9">
                                                        <p class=""
                                                            style="width:25ch; overflow: hidden;
                                                    white-space: nowrap;
                                                    text-overflow: ellipsis;">
                                                            <a href="{{ url('login/consultant') }}" data-qa="job-title"
                                                                data-block-modal="true" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" data-bs-title="Tooltip on top"
                                                                title="{{ $row->project_title }} "
                                                                class=" display-u2u job-title h6 mb-2 "
                                                                style="text-decoration: none;color:#004d1d; ">{{ $row->project_title }}</a>
                                                        </p>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3">
                                                        <div class="btn"
                                                            style="background-color:#D9E4DD; color:#004d1d;border-radius:20px; border-color:#004d1d; width:80px; height:35px; align-items:center">
                                                            Active </div>
                                                ...
                                                <div class="row" style="margin-top: 20px; font-size:12px">
                                                    <div class="col-4">
                                                        <div class="row">
                                                            <p style="color:#004d1d; font-weight:500">Location of Project
                                                            </p>
                                                        </div>
                                                        <div class="row">
                                                ...
                                                <p style="font-size:12px; text-align:justify; margin:0px;"
                                                    data-qa="job-description"
                                                    class="mt-0 pt-1 mb-20 job-description clamp-text">{{ $row->summary }}
                                                </p>
                                            ...
                                            {{-- <div class="skills-list mb-0"
                                            style="padding-left:10px; background-color:#D9E4DD; color:#004d1d; border:1px solid #004d1d; margin:0px 5px">
                                            <span style="background-color: transparent; padding:0px; font-size:13px;"
                                                data-qa="ontology-skill"
                                                class="up-skill-badge disabled">{{ $project_descipline->project_category }}</span>

                                        </div> --}}
                                            <br>
                                            <div class="row" style="margin:5px">
                                                <a class=""
                                                    style="border-radius: 0%; color:#fff; background-color:#004d1d;height:40px; text-align:center;
                                padding:6px; font-weight:500; font-size:14px;"
                                                    target="_blank" href="{{ url('login/consultant') }}">View Detail</a>

                                            </div>


                                            <div role="status" aria-busy="false" aria-label="Section is loading"
                                                class="up-loader-overlay">
        ...
        <div class="container">
            ...
            <div class="row" style="margin: 8px">
                ...
                <div class="col-lg-6 col-md-6 text-center" data-aos="fade-up" data-aos-delay="600">
                    <div class="count-box justify-content-center div">
                        <a href="{{ route('available_projects') }}" style="color:transparent">
        ...
        <div class="row " style="padding: 0px 25px">
            <div class="col-lg-6 col-md-6 d-flex align-items-center">
                <div class="row d-flex">
                    ...
                    <div class="col-lg-9 col-md-9" style="padding:0 25px">
                        ...
                        <p style="font-size:1rem; font-weight:bold; margin-bottom:8px; margin-top:3rem; color:#333333 ">
                            Our
                            Motive </p>
                        <p style="font-size:0.9rem; color:#333333; justify-content-center">The PEC Gateway is launched with
                            a focused objective of
                            promoting local Engineering Talent in international market through coordinated efforts of
                            overseas
                        ...
                        <p style="font-size:0.9rem; color:#333333;justify-content-center">The PEC E-Gateway offers clients
